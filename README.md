...
[ 리액트 + springBoot ] 🥩 정육 판매 쇼핑몰 (제작중)

## 개발 동기
- 프로젝트 협업이 처음인 초짜들이 지금까지 공부했던 항목들을 전부 때려박을 주제를 생각해본 결과 쇼핑몰이라는 결론이 났고, 이왕 만드는거 군침이 도는 정육으로 카테고리를 좁혀봤습니다 !
- 현재 개발 단계중이라 필요한 기능 또는 추가하고 싶은 기능들의 경우 추후 업데이트 예정입니다
